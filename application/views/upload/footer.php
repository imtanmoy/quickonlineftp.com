...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0; margin: 0;">
        ...
        <div style="color: white" class="primaryfooter">
            <div class="col-lg-offset-2 col-lg-3 col-sm-offset-1 col-sm-10 col-xs-offset-1 col-xs-10">
                <div class="addfooter">
                    <h1>Quickonlineftp.com</h1>
                    <span></span>
                    <div class="footer-address">
                        <ul>
                            <li><p><i class="fa fa-map-marker"></i> 145, South Shajahan Pur, Dhaka-1217</p></li>
                            <li><p><i class="fa fa-mobile"></i> Mobile: +88-01610502011</p></li>
                            <!-- <li><p><i class="fa fa-envelope-o"></i> Mail: info@quickonlineline.com</p></li> -->
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="secondary-footer">
            <div class="col-lg-offset-2 col-lg-4 col-sm-12 col-xs-12">
