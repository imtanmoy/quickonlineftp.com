        ...
        <div class="registration-form-wrapper" style="background-color: #f9f9f9;">
            <div style="margin-top: 40px;" class="col-lg-offset-3 col-lg-6">
                <div class="col-lg-12 center-block text-center">
                    <form method="post" action="<?php echo base_url();?>admin/updatemovie" enctype="multipart/form-data">
                        <input type="hidden" name="mid" value="<?php echo $movie[0]->mid?>">
                        <input type="text" name="name" class="input-box" placeholder="<?php echo $movie[0]->name?>">


                        <input type="file" name="poster" style="margin-left: 20px;" placeholder="Select Movie Poster">

                        <input type="text" name="link" class="input-box" placeholder="<?php echo $movie[0]->link?>">
