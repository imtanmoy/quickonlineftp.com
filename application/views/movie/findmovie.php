...
<body style="background: url('<?php echo base_url();?>assets/img/back.jpg')repeat-x center center fixed; padding: 0; margin: 0;" class="col-md-12">
        ...
        <div class="col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8 col-xs-12 col-sm-12">
            ...
            ?>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6" style="overflow: hidden; padding: 2px;">
                    <div class="itembox wow zoomIn">
                        <div class="inneritem">
                            <img class="zoom_image" width="100%" src="<?php echo base_url();?>posters/<?php echo $movie_search[$i]->poster ?>" alt="gdgd">
                            <div class="hovercaption">
                                <a class="button" href="<?php echo base_url()."movie/".$movie_search[$i]->mid?>">Details</a>
                            </div>
                        </div>
