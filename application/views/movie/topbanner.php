...
<audio id="beep-one" preload="auto">
    <source src="<?php echo base_url(); ?>assets/audio/mouse.mp3">
    Your browser isn't invited for super fun time.
</audio>

<audio id="back-sound" preload="auto" loop="true">
    <source src="<?php echo base_url(); ?>assets/audio/sound.mp3">
    Your browser isn't invited for super fun time.
</audio>
...
<audio id="audio" preload="auto" src="<?php echo base_url(); ?>assets/audio/mouse.mp3"></audio>
...
//                    url: "http://localhost/ci/movie/search",
            url: "<?php echo base_url();?>movie/music"
        }).done(function () {
//            alert( "Data Saved: ");
        });
    });
